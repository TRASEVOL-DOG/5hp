...
do -- Weapons --
  ...
  weapons.gun = {
    ...
    ,do_shoot =       function(p) -- determine if weapon should shoot this frame
                        ...
                        if btnp("mouse_lb") then return true
                        elseif btn("mouse_lb") and t() - (w.t_last_shot or 0) > w.fire_rate then return true
                        end                        
                      end
  ...
  weapons.shotgun = {
    ...
    ,do_shoot =       function(p) -- determine if weapon should shoot this frame
                        ...
                        if btnp("mouse_lb") and t() - (w.t_last_shot or 0) > w.fire_rate then return true
                        end                       
                      end
